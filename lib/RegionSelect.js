...
var RegionSelect = (function (_Component) {
  ...
  function RegionSelect(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (RegionSelect.__proto__ || Object.getPrototypeOf(RegionSelect)).call(
        this,
        props
      )
    );

    _this.onComponentMouseTouchDown =
      _this.onComponentMouseTouchDown.bind(_this);
  ...
  _createClass(RegionSelect, [
      ...
      value: function onDocMouseTouchMove(event) {
        ...
        if (!regionChangeData.isMove) {
          var x1Pc = void 0,
            ...
            y2Pc = void 0;
          x1Pc =
            ((regionChangeData.clientPosXStart -
              regionChangeData.imageOffsetLeft) /
              regionChangeData.imageWidth) *
            100;
          y1Pc =
            ((regionChangeData.clientPosYStart -
      ...
      value: function onComponentMouseTouchDown(event) {
        ...
        var xPc =
          ((clientPos.x - imageOffset.left) /
            this.imageRef.current.offsetWidth) *
          100;
        var yPc =
          ((clientPos.y - imageOffset.top) /
            this.imageRef.current.offsetHeight) *
          100;
    ...
    },
    {
      ...
      value: function onRegionMoveStart(event, index) {
        ...
        var regionLeft =
          (currentRegion.x / 100) * this.imageRef.current.offsetWidth +
          imageOffset.left;
        var regionTop =
          (currentRegion.y / 100) * this.imageRef.current.offsetHeight +
          imageOffset.top;
        var regionWidth =
          (currentRegion.width / 100) * this.imageRef.current.offsetWidth;
        var regionHeight =
          (currentRegion.height / 100) * this.imageRef.current.offsetHeight;
